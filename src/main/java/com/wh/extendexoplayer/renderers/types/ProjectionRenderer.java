...
/* package */ final class ProjectionRenderer {
     ...
     */
    static boolean isSupported(Projection projection) {
    ...
    void setProjection(Projection projection) {
        ...
        leftMeshData = new ProjectionRenderer.MeshData(projection.leftMesh.getSubMesh(0));
        rightMeshData =
                projection.singleMesh ? leftMeshData : new ProjectionRenderer.MeshData(projection.rightMesh.getSubMesh(0));
    }
    ...
    /* package */ void draw(int textureId, float[] mvpMatrix, boolean rightEye) {
        ProjectionRenderer.MeshData meshData = rightEye ? rightMeshData : leftMeshData;
        if (meshData == null) {
            return;
        }
    ...
    private static class MeshData {
        ...
        MeshData(Projection.SubMesh subMesh) {
