...
public class GlUtil {
     ...
     * ExoPlayerLibraryInfo#ASSERTIONS_ENABLED} is true throws a {@link RuntimeException}.
     */
    public static void checkGlError() {
        ...
        if (ExoPlayerLibraryInfo.ASSERTIONS_ENABLED && lastError != GLES20.GL_NO_ERROR) {
    ...
    private static void throwGlError(String errorMsg) {
        Log.e(TAG, errorMsg);
        if (ExoPlayerLibraryInfo.ASSERTIONS_ENABLED) {
