...
public class GLTextureView extends TextureView implements TextureView.SurfaceTextureListener {
     ...
     * {@link GLTextureView.GLWrapper#wrap(GL)} method is called
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surface, int width, int height) {
        mGLThread.setSurfaceTexture(surface);
     ...
     * <p>
     * This interface must be implemented by clients wishing to call
     * {@link GLTextureView#setEGLWindowSurfaceFactory(GLTextureView.EGLWindowSurfaceFactory)}
     */
     ...
     * <p>
     * This interface must be implemented by clients wishing to call
     * {@link GLTextureView#setEGLConfigChooser(GLTextureView.EGLConfigChooser)}
     */
    ...
    private static class EglHelper {
         ...
         */
        public boolean createSurface(SurfaceTexture texture) {
            if (LOG_EGL) {
            ...
            if (view != null) {
                mEglSurface = view.mEGLWindowSurfaceFactory.createWindowSurface(mEgl,
                        mEglDisplay, mEglConfig, texture);
            } else {
                mEglSurface = null;
            }
    ...
    static class GLThread extends Thread {
            ...
            try {
                ...
                while (true) {
                    ...
                    if (createEglSurface) {
                        ...
                        if (mEglHelper.createSurface(mSurfaceTexture)) {
                            synchronized (sGLThreadManager) {
        ...
        public void requestRenderAndNotify(Runnable finishDrawing) {
            synchronized (sGLThreadManager) {
                ...
                // has caused reentrancy, for example via updating the TextureView parameters.
