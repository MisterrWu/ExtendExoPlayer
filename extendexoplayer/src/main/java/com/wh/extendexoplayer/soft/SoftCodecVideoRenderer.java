...
public class SoftCodecVideoRenderer extends SoftCodecRenderer {

    private static final String TAG = "SoftCodecVideoRenderer";
    ...
    private SoftCodecVideoRenderer.CodecMaxValues codecMaxValues;
    ...
    /* package */ SoftCodecVideoRenderer.OnFrameRenderedListenerV23 tunnelingOnFrameRenderedListener;
     ...
     */
    public SoftCodecVideoRenderer(Context context, MediaCodecSelector mediaCodecSelector) {
    ...
    protected void configureCodec(
        ...
        codec.configure(mediaFormat, surface, 0);
        if (Util.SDK_INT >= 23 && tunneling) {
            tunnelingOnFrameRenderedListener = new SoftCodecVideoRenderer.OnFrameRenderedListenerV23(codec);
        }
    }
    ...
    private void processOutputFormat(SoftCodec codec, int width, int height) {
        currentWidth = width;
     ...
     * #processOutputBuffer(long, long, SoftCodec, ByteBuffer, int, int, long, boolean, boolean,
     ...
     */
    protected void skipOutputBuffer(SoftCodec codec, int index, long presentationTimeUs) {
     ...
     * @param presentationTimeUs The presentation time of the output buffer, in microseconds.
     */
    protected void dropOutputBuffer(SoftCodec codec, int index, long presentationTimeUs) {
     ...
     */
    protected boolean maybeDropBuffersToKeyframe(SoftCodec codec, int index, long presentationTimeUs,
     ...
     * @param presentationTimeUs The presentation time of the output buffer, in microseconds.
     */
    protected void renderOutputBuffer(SoftCodec codec, int index, long presentationTimeUs) {
        maybeNotifyVideoSizeChanged();
    ...
    protected void renderOutputBufferV21(
            SoftCodec codec, int index, long presentationTimeUs, long releaseTimeNs) {
        maybeNotifyVideoSizeChanged();
        TraceUtil.beginSection("releaseOutputBuffer");
    ...
    @TargetApi(23)
    private static void setOutputSurfaceV23(SoftCodec codec, Surface surface) {
        codec.setOutputSurface(surface);
    }

    @TargetApi(21)
    private static void configureTunnelingV21(MediaFormat mediaFormat, int tunnelingAudioSessionId) {
        mediaFormat.setFeatureEnabled(android.media.MediaCodecInfo.CodecCapabilities.FEATURE_TunneledPlayback, true);
    ...
    protected MediaFormat getMediaFormat(
            Format format,
            SoftCodecVideoRenderer.CodecMaxValues codecMaxValues,
            float codecOperatingRate,
    ...
    /**
     * Returns {@link SoftCodecVideoRenderer.CodecMaxValues} suitable for configuring a codec for {@code format} in a way
     * that will allow possible adaptation to other compatible formats in {@code streamFormats}.
     *
     * @param codecInfo     Information about the {@link SoftCodec} being configured.
     * @param format        The format for which the codec is being configured.
     * @param streamFormats The possible stream formats.
     * @return Suitable {@link SoftCodecVideoRenderer.CodecMaxValues}.
     */
    protected SoftCodecVideoRenderer.CodecMaxValues getCodecMaxValues(
        ...
        if (streamFormats.length == 1) {
            ...
            return new SoftCodecVideoRenderer.CodecMaxValues(maxWidth, maxHeight, maxInputSize);
        }
    ...
    /**
     * Returns whether the codec is known to implement {@link SoftCodec#setOutputSurface(Surface)}
     * incorrectly.
     *
     * <p>If true is returned then we fall back to releasing and re-instantiating the codec instead.
     *
     * @param name The name of the codec.
     * @return True if the device is known to implement {@link SoftCodec#setOutputSurface(Surface)}
     * incorrectly.
     */
    protected boolean codecNeedsSetOutputSurfaceWorkaround(String name) {
        ...
        synchronized (SoftCodecVideoRenderer.class) {
    ...
    @TargetApi(23)
    private final class OnFrameRenderedListenerV23 implements SoftCodec.OnFrameRenderedListener {

        private OnFrameRenderedListenerV23(SoftCodec codec) {
            codec.setOnFrameRenderedListener(this, new Handler());
        }

        @Override
        public void onFrameRendered( SoftCodec codec, long presentationTimeUs, long nanoTime) {
