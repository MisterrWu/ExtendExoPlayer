...
public abstract class SoftCodecRenderer extends BaseRenderer {
    ...
    public static class DecoderInitializationException extends Exception {
         ...
         * to initialize, the {@link SoftCodecRenderer.DecoderInitializationException} for the fallback decoder. Null if
         * there was no fallback decoder or no suitable decoders were found.
         */
        public final SoftCodecRenderer.DecoderInitializationException fallbackDecoderInitializationException;
        ...
        private DecoderInitializationException(
                ...
                boolean secureDecoderRequired,
                 ...
                 SoftCodecRenderer.DecoderInitializationException fallbackDecoderInitializationException) {
            super(message, cause);
        ...
        private SoftCodecRenderer.DecoderInitializationException copyWithFallbackException(
                SoftCodecRenderer.DecoderInitializationException fallbackException) {
            return new SoftCodecRenderer.DecoderInitializationException(
                    getMessage(),
                    getCause(),
                    mimeType,
                    secureDecoderRequired,
        ...
        private static String getDiagnosticInfoV21(Throwable cause) {
            if (cause instanceof SoftCodec.CodecException) {
                return ((SoftCodec.CodecException) cause).getDiagnosticInfo();
            }
            return null;
        }
    ...
    private static final String TAG = "SoftCodecRenderer";

    /**
     * If the {@link SoftCodec} is hotswapped (i.e. replaced during playback), this is the period of
    ...
    /**
     * The possible return values for {@link #canKeepCodec(SoftCodec, MediaCodecInfo, Format,
     * Format)}.
     */
    @Documented
    ...
    private float rendererOperatingRate;
     private SoftCodec codec;
     private Format codecFormat;
    private float codecOperatingRate;
     private ArrayDeque<MediaCodecInfo> availableCodecInfos;
     private SoftCodecRenderer.DecoderInitializationException preferredDecoderInitializationException;
    ...
    /**
     * Configures a newly created {@link SoftCodec}.
     *
     * @param codecInfo Information about the {@link SoftCodec} being configured.
     * @param codec The {@link SoftCodec} to configure.
    ...
    protected final void maybeInitCodec() throws ExoPlaybackException {
        ...
        } catch (SoftCodecRenderer.DecoderInitializationException e) {
            throw ExoPlaybackException.createForRenderer(e, getIndex());
        }
    }
    ...
    protected final SoftCodec getCodec() {
        return codec;
    }
    ...
    private void maybeInitCodecWithFallback(
            ...
            throws SoftCodecRenderer.DecoderInitializationException {
        if (availableCodecInfos == null) {
            try {
                ...
                throw new SoftCodecRenderer.DecoderInitializationException(
                        inputFormat,
                        e,
                        mediaCryptoRequiresSecureDecoder,
                        SoftCodecRenderer.DecoderInitializationException.DECODER_QUERY_ERROR);
            }
        }
        ...
        if (availableCodecInfos.isEmpty()) {
            throw new SoftCodecRenderer.DecoderInitializationException(
                    ...
                    /* cause= */ null,
                    mediaCryptoRequiresSecureDecoder,
                    SoftCodecRenderer.DecoderInitializationException.NO_SUITABLE_DECODER_ERROR);
        }
        ...
        while (codec == null) {
            ...
            try {
                ...
                SoftCodecRenderer.DecoderInitializationException exception =
                        new SoftCodecRenderer.DecoderInitializationException(
    ...
    private void initCodec(MediaCodecInfo codecInfo, MediaCrypto crypto) throws Exception {
        ...
        try {
            ...
            codec = SoftCodec.createByCodecName(codecName);
            TraceUtil.endSection();
    ...
    private boolean feedInputBuffer() throws ExoPlaybackException {
        ...
        if (codecDrainState == DRAIN_STATE_SIGNAL_END_OF_STREAM) {
            ...
            if (codecNeedsEosPropagation) {
                ...
                codec.queueInputBuffer(inputIndex, 0, 0, 0, SoftCodec.BUFFER_FLAG_END_OF_STREAM);
                resetInputBuffer();
            }
        ...
        if (buffer.isEndOfStream()) {
            ...
            } catch (SoftCodec.CryptoException e) {
                throw ExoPlaybackException.createForRenderer(e, getIndex());
            }
            return false;
        }
    ...
    /**
     * Called when a {@link SoftCodec} has been created and configured.
     * <p>
     ...
     * @throws ExoPlaybackException If an error occurs re-initializing the {@link SoftCodec}.
     */
    ...
    /**
     * Called when the output format of the {@link SoftCodec} changes.
     * <p>
     * The default implementation is a no-op.
     *
     ...
     */
    protected void onOutputFormatChanged(SoftCodec codec, MediaFormat outputFormat)
    ...
    /**
     * Determines whether the existing {@link SoftCodec} can be kept for a new format, and if it can
     * whether it requires reconfiguration.
     *
     * <p>The default implementation returns {@link #KEEP_CODEC_RESULT_NO}.
     *
     * @param codec The existing {@link SoftCodec} instance.
    ...
    protected @KeepCodecResult int canKeepCodec(
            SoftCodec codec, MediaCodecInfo codecInfo, Format oldFormat, Format newFormat) {
    ...
    private boolean drainOutputBuffer(long positionUs, long elapsedRealtimeUs)
        ...
        if (!hasOutputBuffer()) {
            ...
            if (shouldSkipAdaptationWorkaroundOutputBuffer) {
                ...
                return true;
                    ...
                    && (outputBufferInfo.flags & SoftCodec.BUFFER_FLAG_END_OF_STREAM) != 0) {
        ...
        if (processedOutputBuffer) {
            ...
            boolean isEndOfStream = (outputBufferInfo.flags & SoftCodec.BUFFER_FLAG_END_OF_STREAM) != 0;
            resetOutputBuffer();
            if (!isEndOfStream) {
                return true;
            }
     ...
     * SoftCodec#BUFFER_FLAG_END_OF_STREAM} flag incorrectly on the host device.
     *
     ...
     * underlying decoder.
     *
     * @param codecInfo Information about the {@link SoftCodec}.
     * @return True if the decoder is known to handle {@link SoftCodec#BUFFER_FLAG_END_OF_STREAM}
     ...
     *     buffer with {@link SoftCodec#BUFFER_FLAG_END_OF_STREAM} set. False otherwise.
     */
